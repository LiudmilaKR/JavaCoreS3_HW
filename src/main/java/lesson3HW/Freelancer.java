...
public class Freelancer extends Employee {
     ...
     * @param surName фамилия  фрилансера
     * @param salary ставка заработной платы  фрилансера
     */
    public Freelancer(String name, String surName, double salary) { super(name, surName, salary); }
